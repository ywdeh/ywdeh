...
<div class="fixed flex items-center justify-center inset-0 z-90">
    ...
    <div class="fixed bottom-0 w-full max-w-261 h-[90%]" transition:slideY>
        <div class="flex flex-col w-full h-full bg-neutral-900 rounded-t-xl overflow-y-auto overscroll-contain px-5 pb-10 md:px-10 md:pb-15 font-normal scrollbar-none!">

            <div class="z-80 flex w-full sticky bg-neutral-900/98 backdrop-blur-lg py-10 justify-between -top-1.25 md:top-0">
                <h1>{title}</h1>

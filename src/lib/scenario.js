export const scenario = {
    ...
    "portfolio": {
        title: "my portfolio",
        component: () => import("$lib/components/scenario/portfolio.svelte"),
    },
    ...
    "dino-cafe": {
        title: "cafe full rebranding",
        component: () => import("$lib/components/scenario/dino-cafe.svelte"),
    },

    "sneakers-bros": {
        title: "sneakers store logo & socials banners",
    ...
    "paladins-concept": {
        title: "game ux/ui redesign concept",
    ...
    "blue-animation": {
        title: "blue - simple illustrated character",
        component: () => import("$lib/components/scenario/blue-animated.svelte"),
    },

    "thats-what-journey-means": {
